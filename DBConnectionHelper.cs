...
namespace VignaharaServices
{
    ...
    public class DbConnectionHelper : IDbConnectionHelper
    {
        ...
        {
            ConnectionStringSettings connObj = ConfigurationManager.ConnectionStrings["VignaharaDNNEntities"]; // FRAGILE: The name of the connectionString in web.connection.config
            if (connObj == null)
            {
